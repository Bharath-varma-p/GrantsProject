...
// Load XML file
const xmlFilePath = '/Users/bharath/Documents/GrantsPortal/GrantsProject/Downloaded_data/GrantsDBExtract20231006v2.xml';
...
async function main() {
  const csvFilePath = path.join(path.dirname(xmlFilePath), 'opportunities.csv'); // Create CSV path
